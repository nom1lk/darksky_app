...
Condition.create(
         ...
         nesiko_today: @Niseko_today,
         nesiko_tommorrow: @Niseko_tomorrow,
         nesiko_three_day: @Niseko_three_day,
         nesiko_seven_day: @Niseko_seven_day,

         rusutsu_today: @Rusutsu_today,
         rusutsu_tommorrow: @Rusutsu_tomorrow,
         rusutsu_three_day: @Rusutsu_three_day,
         rusutsu_seven_day: @Rusutsu_seven_day,
         
         furano_today: @Furano_today,
         furano_tommorrow: @Furano_tomorrow,
         furano_three_day: @Furano_three_day,
         furano_seven_day: @Furano_seven_day,

         kiroro_today: @Kiroro_today,
         kiroro_tommorrow: @Kiroro_tomorrow,
         ...
         shiga_kogen_tommorrow: @Shiga_Kogen_tomorrow,
         ...
         myoko_kogen_tommorrow: @Myoko_Kogen_tomorrow,
         ...
         phoenix_snow_park_tommorrow: @Phoenix_Snow_Park_tomorrow,
         ...
         high1_resort_tommorrow: @High1_Resort_tomorrow,
         ...
         vivaldi_park_tommorrow: @Vivaldi_Park_tomorrow,
...
# rails g model today:float tomorrow:float three_day:float seven_day:float
...
## Model creation:
# niseko_today:float niseko_tomorrow:float niseko_three_day:float niseko_seven_day:float rusutsu_today:float rusutsu_tomorrow:float rusutsu_three_day:float rusutsu_seven_day:float furano_today:float furano_tomorrow:float furano_three_day:float furano_seven_day:float kiroro_today:float kiroro_tomorrow:float kiroro_three_day:float kiroro_seven_day:float hakuba_today:float hakuba_tomorrow:float hakuba_three_day:float hakuba_seven_day:float nozawa_onsen_today:float nozawa_onsen_tomorrow:float nozawa_onsen_three_day:float nozawa_onsen_seven_day:float shiga_kogen_today:float shiga_kogen_tomorrow:float shiga_kogen_three_day:float shiga_kogen_seven_day:float myoko_kogen_today:float myoko_kogen_tomorrow:float myoko_kogen_three_day:float myoko_kogen_seven_day:float yongpyong_today:float yongpyong_tomorrow:float yongpyong_three_day:float yongpyong_seven_day:float alpensia_today:float alpensia_tomorrow:float alpensia_three_day:float alpensia_seven_day:float phoenix_snow_park_today:float phoenix_snow_park_tomorrow:float phoenix_snow_park_three_day:float phoenix_snow_park_seven_day:float high1_resort_today:float high1_resort_tomorrow:float high1_resort_three_day:float high1_resort_seven_day:float vivaldi_park_today:float vivaldi_park_tomorrow:float vivaldi_park_three_day:float vivaldi_park_seven_day:float yabuli_today:float yabuli_tomorrow:float yabuli_three_day:float yabuli_seven_day:float beidahu_today:float beidahu_tomorrow:float beidahu_three_day:float beidahu_seven_day:float changbaishan_today:float changbaishan_tomorrow:float changbaishan_three_day:float changbaishan_seven_day:float chongli_today:float chongli_tomorrow:float chongli_three_day:float chongli_seven_day:float

           
         niseko_today:float niseko_tomorrow:float niseko_three_day:float niseko_seven_day:float
         rusutsu_today:float rusutsu_tomorrow:float rusutsu_three_day:float rusutsu_seven_day:float
         furano_today:float furano_tomorrow:float furano_three_day:float furano_seven_day:float
         kiroro_today:float kiroro_tomorrow:float kiroro_three_day:float kiroro_seven_day:float
         
         hakuba_today:float hakuba_tomorrow:float hakuba_three_day:float hakuba_seven_day:float
         nozawa_onsen_today:float nozawa_onsen_tomorrow:float nozawa_onsen_three_day:float nozawa_onsen_seven_day:float
         shiga_kogen_today:float shiga_kogen_tomorrow:float shiga_kogen_three_day:float shiga_kogen_seven_day:float
         myoko_kogen_today:float myoko_kogen_tomorrow:float myoko_kogen_three_day:float myoko_kogen_seven_day:float
         
         yongpyong_today:float yongpyong_tomorrow:float yongpyong_three_day:float yongpyong_seven_day:float
         alpensia_today:float alpensia_tomorrow:float alpensia_three_day:float alpensia_seven_day:float
         phoenix_snow_park_today:float phoenix_snow_park_tomorrow:float phoenix_snow_park_three_day:float phoenix_snow_park_seven_day:float
         vivaldi_park_today:float vivaldi_park_tomorrow:float vivaldi_park_three_day:float vivaldi_park_seven_day:float

         yabuli_today:float yabuli_tomorrow:float yabuli_three_day:float yabuli_seven_day:float
         beidahu_today:float beidahu_tomorrow:float beidahu_three_day:float beidahu_seven_day:float
         changbaishan_today:float changbaishan_tomorrow:float nchangbaishan_three_day:float changbaishan_seven_day:float
         chongli_today:float chongli_tomorrow:float chongli_three_day:float chongli_seven_day:float
